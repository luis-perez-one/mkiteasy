...
## Archivos .csv
- Un archivo con extención .csv *(comma-separated values)* es un archivo de texto que usa un caractér delimitador (típicamente una coma) para separar un valor. Cada línea (o renglón) del archivo corresponde a una fila, mientras que cada fila consiste de uno o más campos separados por el caractér delimitador.
