 ...
 * Pueden actuar como tablas agregadas, donde el motor de la BDD agrega la información a través de funciones como (`SUM`, `AVERAGE`, `MAX`, `MIN`, etc) y presenta los resultados calculados como parte de la información. 
