...
|parámetro|default|
|---|---|
|`--host`|asume que la BDD está en nuestro propio equipo, es decir `localhost`. En la mayoría de los sistemas operativos corresponde a la IP `127.0.0.1`  [chiste geek](https://medium.com/@hackersleaguebooks/theres-no-place-like-127-0-0-1-explained-1e6af9368e32)|
