...
|`\d [nombre tabla]`| describre una tabla, sus campos (columnas) el tipo de datos de cada una, restricciones, llaves primarias, llaves foraneas y triggers relacionados | 
