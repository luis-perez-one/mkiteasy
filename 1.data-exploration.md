...
:bulb: puedes ejecutar desde el terminal el comando ```console psql --help``` para ver otras opciones que puedes utilizar en la configuración de la conexión a la BDD.
