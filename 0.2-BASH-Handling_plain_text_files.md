...
Si quisieramos utilizar `sed` para contar las líneas de un archivo .csv y de ahí inferir el número de registros que existe en la tabla, lo primero que tendríamos que hacer es asegurarnos de que no existan líneas en blanco. Para hacer esto utilizaríamos el siguiente comando:
